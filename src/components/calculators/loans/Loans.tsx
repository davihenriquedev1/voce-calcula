...
import { LoansFormValues, LoansSummary as LoansSummaryType, Schedule } from "@/types/loans";
...
import { amortizationTypeOptions, creditOptions } from '@/constants/loans';
...
const Loans = () => {
    ...
    const onSubmit = (values: LoansFormValues) => {
        ...
        const finalize = (rawSchedule: Schedule[]) => {
