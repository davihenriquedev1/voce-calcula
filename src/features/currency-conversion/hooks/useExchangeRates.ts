...
import { getExchangeRates } from '../services/exchange-rates'; // Função que vai fazer a requisição à API de câmbio
import { MetaExchangeRates } from '../types'; // Tipagem TypeScript para os dados que a API retorna
