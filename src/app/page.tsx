	...
	return (
		<div className="flex flex-col w-full items-center justify-center">
			...
			<section className="flex flex-col w-full px-4 py-10 gap-8 md:px-10 md:py-14 ">
				...
				<div className="grid grid-cols-2 md:grid-cols-3 h-full gap-3 md:gap-8">
					...
					<Frame route="/conversor-de-moedas" title="Conversão de Moedas" desc="Veja a conversão de Real pra Dólar e muito mais." bgColor="bg-softgray" bgColorTitle="bg-chart-5" colorTitle="text-section2" cardIcon="/images/cards/exchange-card.png"/>
					<Frame route="/taxa-basal" title="Calculadora de Taxa Basal" desc="Veja o quanto seu corpo gasta de calorias diariamente." bgColorTitle="bg-white" colorTitle="text-section2" bgColor="bg-chart-5" cardIcon="/images/cards/bmr-card.png" />
				</div>
			</section>
