...
const Page = () => {
    ...
    return (
        <div className="p-4 flex flex-col md:flex-row min-h-screen">
            <div className="mx-4 p-6 flex-1 flex items-center relative">
                <div className="absolute inset-0 bg-chart-5 opacity-30" />
                <div className="flex flex-col relative z-10 md:ml-20">
                    <h1 className="text-4xl font-bold text-foreground opacity-100 z-20">Contate-nos</h1>
            ...
            <div className="p-2 flex-1 m-2 flex justify-center items-center">
                <Form {...form}>
